              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Última tentativa: ${formatTimestamp(notification.updatedAt)}',
...
class _StatusChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final label = statusCode == null ? 'sem status' : 'HTTP $statusCode';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text(
                'Quando o backend responder diferente de 201, a tentativa ficará listada aqui com os detalhes da requisição e da resposta.',
                textAlign: TextAlign.center,
